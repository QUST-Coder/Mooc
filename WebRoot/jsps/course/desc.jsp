...
<div id="desc_main">
	<div class="c_desc">
		...
		<div class="c_do">
			<div style="background-color:#000000;">
				<a href="#" class="concern"><img src="<c:url value='/jsps/images/concern.png'/>"/><span>关注课程</span></a>
			</div>
	...
	<div class="c_info">
		<div class="s_img">
			<a href="#" title="${course.school.sch_name }"><img src="<c:url value='/${course.school.sch_simg }'/>"/></a>
		</div>
		<div class="c_intro">
			<h3>课程介绍</h3>
			<p>${course.cou_desc }</p>
				...
				<div class="chapter">
					...
					<ul>
						<c:forEach items="${chapter.videos }" var="video">
						 <li><a href="#">${video.vid_num }: ${video.vid_name }</a></li>
						 <c:choose>
